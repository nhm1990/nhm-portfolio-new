...
definePageMeta({ layout: 'ecoscope' })
...
const { generateCityData, recalculateAqi } = useEnvData()

const gridApi = ref<GridApi | null>(null)
const quickFilterText = ref('')
const rowData = ref<AirQualityReading[]>(generateCityData())
...
function refreshData(): void {
  rowData.value = generateCityData()
